...
SDL_Rect posicao_vitoria1;
SDL_Rect posicao_vitoria2;

//TECLADO PARA OS 2 PLAYERS SEM CONFLITO
void teclado_atualizado_fabrica(teclas* estado_teclado)
{
    SDL_Event event;
...
//CRIAÇÃO DA POSIÇÃO DO CENÁRIO E DA SUA IMAGEM
    ...
    SDL_Surface *vitoriaj1 = NULL;
    SDL_Surface *vitoriaj2 = NULL;
...
//CRIAÇÃO DA MÚSICA DE BATALHA
    ...
    Mix_Music *musica_fabrica = NULL;
    musica_fabrica = Mix_LoadMUS("fabrica.mp3");

    Mix_PlayMusic(musica_fabrica, -1);
...
//CARREGAMENTO DAS IMAGENS
    ...
    bloco = IMG_Load("blocofabrica1.png");
    cenario = IMG_Load("fabrica.png");

    bloco_1 = IMG_Load("blocofabrica2.bmp");
    bloco_2 = IMG_Load("blocofabrica3.bmp");
    bloco_3 = IMG_Load("blocofabrica4.bmp");
    bloco_4 = IMG_Load("blocofabrica5.bmp");
    bloco_5 = IMG_Load("blocofabrica6.bmp");
    bloco_6 = IMG_Load("blocofabrica7.bmp");
...
//MOVIMENTAÇÃO DOS JOGADORES
    while(gContinuar == 1)
    {
        ...
        {
            criacao_bomba_j1_fabrica (mapa, tela5);
        }
        ...
        {
            criacao_bomba_j2_fabrica(mapa, tela5);
        }
       ...
       SDL_FillRect(tela5,NULL,SDL_MapRGB(tela5 -> format,0,0,0));

//POSIÇÃO DO CENARIO NA TELA
        posicao_cenario.x = 0;
        posicao_cenario.y = 36;

        SDL_BlitSurface(cenario, NULL, tela5, &posicao_cenario);
...
//CRIAÇÃO ANIMAÇÃO DOS BLOCOS E EFEITOS DE EXPLOSÃO
        for (i = 1; i < 10; i++)
        {
            for (j = 1; j < 14; j++)
            {
               ...
               posicao.y = i*tamanho_bloco+21;
                ...
                {
                    case 2:
                    SDL_BlitSurface(bloco, NULL, tela5, &posicao);
                    break;

                    case 5:
                    SDL_BlitSurface(bomba_1, NULL, tela5, &posicao);
                    break;

                    case 10:
                    SDL_BlitSurface(explosao_m, NULL, tela5, &posicao);
                    break;

                    case 6:
                    SDL_BlitSurface(explosao_b, NULL, tela5, &posicao);
                    break;

                    case 7:
                    SDL_BlitSurface(explosao_c, NULL, tela5, &posicao);
                    break;

                    case 8:
                    SDL_BlitSurface(explosao_d, NULL, tela5, &posicao);
                    break;

                    case 9:
                    SDL_BlitSurface(explosao_e, NULL, tela5, &posicao);
                    break;

                    case 11:
                    SDL_BlitSurface(bomba_2, NULL, tela5, &posicao);
                    break;

                    case 12:
                    SDL_BlitSurface(bloco_1, NULL, tela5, &posicao);
                    break;

                    case 13:
                    SDL_BlitSurface(bloco_2, NULL, tela5, &posicao);
                    break;

                    case 14:
                    SDL_BlitSurface(bloco_3, NULL, tela5, &posicao);
                    break;

                    case 15:
                    SDL_BlitSurface(bloco_4, NULL, tela5, &posicao);
                    break;

                    case 16:
                    SDL_BlitSurface(bloco_5, NULL, tela5, &posicao);
                    break;

                    case 17:
                    SDL_BlitSurface(bloco_6, NULL, tela5, &posicao);
                    break;

                    case 18:
                    SDL_BlitSurface(bomba_v1, NULL, tela5, &posicao);
                    break;

                    case 19:
                    SDL_BlitSurface(bomba_v2, NULL, tela5, &posicao);
                    break;
                }
            }
        }
        ...
        SDL_BlitSurface(jogador_1_atual,NULL,tela5,&posicao);

        posicao_2.x = posicao_jogador_2.x*tamanho_bloco;
        posicao_2.y = posicao_jogador_2.y*tamanho_bloco;

        SDL_BlitSurface(jogador_2_atual,NULL,tela5,&posicao_2);
...
//VELOCIDADE DE MOVIMENTO DOS JOGADORES
    ...
    if(gContinuar == 5)//PLAYER 2
    {
        ...
        SDL_BlitSurface(vitoriaj2, NULL, tela5, &posicao_vitoria2);
...
void movimento_jogador_fabrica(int **mapa, SDL_Rect *pos, int direcao)
{
    switch(direcao)
    {
        case cima:
...
void criacao_bomba_j1_fabrica (int **mapa, SDL_Surface* tela5)
{
    ...
    j1.tela_bomba_j1 = tela5;

    pthread_create(&limite_bomba_j1, NULL, gerenciamento_bomba_j1_fabrica, (void*)&j1);
}
...
void criacao_bomba_j2_fabrica (int **mapa, SDL_Surface* tela5)
{
    ...
    j2.tela_bomba_j2 = tela5;

    pthread_create(&limite_bomba_j2, NULL, gerenciamento_bomba_j2_fabrica, (void*)&j2);
}
...
//ANIMAÇÃO BLOCOS SENDO DESTRUIDOS JOGADOR 2
    ...
    switch (bloco_soma_2)
    {
        ...
        case 14:
        mapa_bomba_j2[right_linha_2][right_coluna_2] = 12;
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 12;
        SDL_Delay(50);

        mapa_bomba_j2[right_linha_2][right_coluna_2] = 13;
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 13;
        SDL_Delay(50);

        mapa_bomba_j2[right_linha_2][right_coluna_2] = 14;
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 14;
        SDL_Delay(50);

        mapa_bomba_j2[right_linha_2][right_coluna_2] = 15;
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 15;
        SDL_Delay(50);

        mapa_bomba_j2[right_linha_2][right_coluna_2] = 16;
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 16;
        SDL_Delay(50);

        mapa_bomba_j2[right_linha_2][right_coluna_2] = 17;
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 17;
        SDL_Delay(50);
        ...
        case 15:
        mapa_bomba_j2[up_linha_2][up_coluna_2] = 12;
        mapa_bomba_j2[down_linha_2][down_coluna_2] = 12;
        mapa_bomba_j2[left_linha_2][left_coluna_2] = 12;
        SDL_Delay(50);

        mapa_bomba_j2[up_linha_2][up_coluna_2] = 13;
        mapa_bomba_j2[down_linha_2][down_coluna_2] = 13;
        mapa_bomba_j2[left_linha_2][left_coluna_2] = 13;
        SDL_Delay(50);

        mapa_bomba_j2[up_linha_2][up_coluna_2] = 14;
        mapa_bomba_j2[down_linha_2][down_coluna_2] = 14;
        mapa_bomba_j2[left_linha_2][left_coluna_2] = 14;
        SDL_Delay(50);

        mapa_bomba_j2[up_linha_2][up_coluna_2] = 15;
        mapa_bomba_j2[down_linha_2][down_coluna_2] = 15;
        mapa_bomba_j2[left_linha_2][left_coluna_2] = 15;
        SDL_Delay(50);

        mapa_bomba_j2[up_linha_2][up_coluna_2] = 16;
        mapa_bomba_j2[down_linha_2][down_coluna_2] = 16;
        mapa_bomba_j2[left_linha_2][left_coluna_2] = 16;
        SDL_Delay(50);

        mapa_bomba_j2[up_linha_2][up_coluna_2] = 17;
        mapa_bomba_j2[down_linha_2][down_coluna_2] = 17;
        mapa_bomba_j2[left_linha_2][left_coluna_2] = 17;
        SDL_Delay(50);
